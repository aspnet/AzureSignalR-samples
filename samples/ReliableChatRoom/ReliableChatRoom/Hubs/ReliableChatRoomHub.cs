...
namespace Microsoft.Azure.SignalR.Samples.ReliableChatRoom.Hubs
{
    public class ReliableChatRoomHub : Hub
    {
        ...
        public async void EnterChatRoom(string deviceUuid, string username)
        {
        ...
        public async void LeaveChatRoom(string connectionId)
        {
        ...
        public async void OnBroadcastMessageReceived(string messageId, string sender, string payload)
        {
            ...
            await _messageStorage.TryStoreMessageAsync(message, SendBroadCastMessage);
        }
        ...
        /// <param name="payload">The message content. Can be string / binary object in base64</param>
        public async void OnPrivateMessageReceived(string messageId, string sender, string receiver, string payload)
        {
            ...
            //  Try to store the message and execute a callback 
            await _messageStorage.TryStoreMessageAsync(message, SendPrivateMessage);
        }
        ...
        public async void OnReadResponseReceived(string messageId, string username)
        {
        ...
        private async Task SendHistoryMessages(List<Message> historyMessages, IHubContext<ReliableChatRoomHub> hubContext)
        {
            await hubContext.Clients.Client(Context.ConnectionId)
                .SendAsync("addHistoryMessages", JsonConvert.SerializeObject(historyMessages));
        }
